...
exports.resetPassword = exports.forgotPassword = exports.myProfile = exports.changePassword = exports.signUp = exports.logIn = exports.createUser = void 0;
...
const password_token_1 = require("../models/password-token");
...
function forgotPassword(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const passToken = yield password_token_1.PasswordToken.findOne({ email: email });
            if (passToken)
                yield password_token_1.PasswordToken.findByIdAndDelete(passToken._id);
            const payload = { email: email };
            const token = jsonwebtoken_1.default.sign(payload, process.env.SECRET_KEY);
            console.log("token", token);
            const newPassToken = new password_token_1.PasswordToken({ email: email, token: token });
...
function resetPassword(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const payload = jsonwebtoken_1.default.verify(receivedToken, process.env.SECRET_KEY);
            const passToken = yield password_token_1.PasswordToken.findOne({ email: payload["email"] });
            if (!passToken) {
                return res.status(401).json({ message: "Invalid token" });
            }
            ...
            yield password_token_1.PasswordToken.findOneAndDelete({ email: email });
